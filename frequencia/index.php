...
<div class="d-flex">
  ...
  <div class="flex-grow-1 p-4">
    <h2>Frequência</h2>
    <p class="text-muted">Lista de frequência mensal dos profissionais.</p>
    <div class="alert alert-info">
      Esta seção está em desenvolvimento. Em breve você poderá registrar e visualizar a frequência mensal dos profissionais.
    </div>
  </div>
</div>
